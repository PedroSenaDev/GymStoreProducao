...
import { Loader2, LayoutDashboard, Package, Tags, User, LogOut, Settings, ExternalLink, ShoppingCart, Megaphone } from 'lucide-react';
...
const links = [
  ...
  { to: '/admin/campaigns', label: 'Campanhas', icon: <Megaphone size={20} /> },
